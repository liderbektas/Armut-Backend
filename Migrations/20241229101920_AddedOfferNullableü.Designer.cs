...
namespace Test_Case.Migrations
{
    ...
    [Migration("20241229101920_AddedOfferNullableü")]
    partial class AddedOfferNullableü
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Test_Case.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 12, 29, 10, 19, 20, 120, DateTimeKind.Utc).AddTicks(2490),
                            CreditCardCvvCode = "",
                            CreditCardLastMonth = "",
                            CreditCardLastYear = "",
                            CreditCardNumber = "",
                            ...
                            Password = "admin",
                            Role = "Admin",
                            UpdatedAt = new DateTime(2024, 12, 29, 10, 19, 20, 120, DateTimeKind.Utc).AddTicks(2490),
                            isVerified = true
                        });
                });
            ...
            modelBuilder.Entity("Test_Case.Models.Service", b =>
                {
                    b.HasOne("Test_Case.Models.User", null)
                        .WithMany("Services")
                        .HasForeignKey("UserId");
                });
